...
**Статус: ранняя версия 0.1.0.** Реальная интеграция работает в режиме чтения учебных данных. Выставление оценок и отправку заданий можно попробовать только в отдельной демонстрации. Проект не является официальным продуктом академии TOP.
...
- **Node.js 24** (поддерживаемый минимум — 22.6) и npm.
...
- **Домашние задания / Материалы:** смотрите данные, доступные аккаунту; для материалов текущей пары используйте кнопку загрузки.
